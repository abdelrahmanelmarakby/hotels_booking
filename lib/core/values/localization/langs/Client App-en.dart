...
Map<String, String> en = {
  ...
  LocalKeys.kAddToWaitingList: "Add To Waiting List",
  LocalKeys.kSwitchToBranch: "Switch To Branch",
  LocalKeys.kOrderWaitingList: "Your Order In Waiting List",
  LocalKeys.kBackHome: "Back to Home",

  // Add Addess
  LocalKeys.kAddAddess: 'Add Addess',
  LocalKeys.kAddressName: "Address Name",
  LocalKeys.kAddressType: "Address Type",
  LocalKeys.kOffice: "Office",
  LocalKeys.kArea: "Area",
  LocalKeys.kBuilding: "Building",
  ...
  // Change Your Email
  LocalKeys.kChangeYourEmail: "Change Your Email",
  LocalKeys.kEmail: "Email",
...
// OnBoarding
  ...
  LocalKeys.kOnboardin1Title: "Healthy Food In Simple Steps",
  LocalKeys.kOnboardin1SubTitle: "Find all kinds of healthy food in one app",
  LocalKeys.kOnboardin2Title: "Easy To Communicate",
  LocalKeys.kOnboardin2SubTitle: "Reach your favourite provider on the app",
  LocalKeys.kOnboardin3Title: "Daily Goals Tracking",
  LocalKeys.kOnboardin3SubTitle: "Get Insights About Your Daily Healthy Rutin",
...
// Custom Package
  ...
  LocalKeys.kHardExercise: "Hard Exercise: 6-7 Workouts/Week",
  LocalKeys.kExtremelyActive:
      "Extremely Active: Hard Daily Exercise Or Two Times A Day Training",
  LocalKeys.kStep: "Step",
  LocalKeys.kOf: "Of",
  ...
  // Days Times
  LocalKeys.kStartingDay: "Starting Day",
  ...
  LocalKeys.kMeals: "Meals",
  LocalKeys.kPackages: "Packages",
  LocalKeys.kProfile: "Profile",
  LocalKeys.kPerfectPackages: "Find Your Perfect Packages",
  ...
  LocalKeys.kCarb: "Carb",
  LocalKeys.kProtein: "Protein",
  LocalKeys.kFat: "Fat",

  // Notifications
  LocalKeys.kNotifications: "Notifications",
  LocalKeys.kAllIncomingActivity: "All Incoming Activity",

  // Package Details
  LocalKeys.kPackageDetails: "Package Details",
  LocalKeys.kFromBranch: "From Branch",
  LocalKeys.kPlanType: "Plan Type",

  //Select Meals
  LocalKeys.kSelectMeals: "Select Meals",
  LocalKeys.kResultforYour: "Result for Your",
  LocalKeys.kSnacks: "Snacks",
  LocalKeys.kPriceForAdditionalPackages: "Price For Additional Packages",
  LocalKeys.kSAR: "SAR",
  LocalKeys.kPackagePrice: "Package Price",

  // Package
  LocalKeys.kMonthly: "Monthly",
  LocalKeys.kWeekly: "Weekly",
  LocalKeys.kAllPackages: "All Packages",
  ...
  LocalKeys.kRecentSearch: "Recent Search",

  // Subscription
  LocalKeys.kMySubscription: "My Subscription",
  LocalKeys.kCurrent: "Current",
  LocalKeys.kPrevious: "Previous",
  LocalKeys.kEndedAt: "Ended At",
  ...
  LocalKeys.kRenew: "Renew",
  LocalKeys.kRemainingDays: "Remaining Days",
  LocalKeys.kBranch: "Branch",
  ...
  LocalKeys.kcurrentlyunsubscribed:
      "You're currently unsubscribed to this package",
  LocalKeys.kDeliveredDays: "Delivered Days",
  LocalKeys.kRefund: "Refund",
  LocalKeys.kReturnPaymentMethod: "Return Payment Method",
  LocalKeys.kPauseSubscription: "Pause Subscription",
  LocalKeys.kPauseFrom: "Pause From",
  LocalKeys.kResumeFrom: "Resume From",
